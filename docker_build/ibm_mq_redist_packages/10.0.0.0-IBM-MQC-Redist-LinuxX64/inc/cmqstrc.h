 ...
 const struct MQI_BY_VALUE_STR {
  ...
  char *name;
   ...
   {          13, "MQCDC_CURRENT_VERSION" },
   {          13, "MQCDC_VERSION_13" },
   {          13, "MQCD_CURRENT_VERSION" },
   {          13, "MQCD_VERSION_13" },
   {          13, "MQCFOP_EXCLUDES" },
   ...
   {        1952, "MQCDC_CURRENT_LENGTH (4 byte)" },
   {        1952, "MQCDC_LENGTH_13 (4 byte)" },
   {        1952, "MQCD_CURRENT_LENGTH (4 byte)" },
   {        1952, "MQCD_LENGTH_13 (4 byte)" },
   {        1984, "MQCDC_LENGTH_11 (8 byte)" },
   {        1984, "MQCD_LENGTH_11 (8 byte)" },
   {        1992, "MQCDC_LENGTH_12 (8 byte)" },
   {        1992, "MQCD_LENGTH_12 (8 byte)" },
   {        2000, "MQCDC_CURRENT_LENGTH (8 byte)" },
   {        2000, "MQCDC_LENGTH_13 (8 byte)" },
   {        2000, "MQCD_CURRENT_LENGTH (8 byte)" },
   {        2000, "MQCD_LENGTH_13 (8 byte)" },
   {        2000, "MQIA_LAST" },
   {        2000, "MQIA_USER_LIST" },
   {        2001, "MQCA_APPL_ID" },
   {        2001, "MQCA_FIRST" },
 ...
 const struct MQI_BY_NAME_STR {
  ...
  MQLONG value;
   ...
   {  "MQCC_UNKNOWN"                    ,         -1 },
   {  "MQCC_WARNING"                    ,          1 },
   {  "MQCDC_CURRENT_LENGTH (4 byte)"   ,       1952 },
   {  "MQCDC_CURRENT_LENGTH (8 byte)"   ,       2000 },
   ...
   {  "MQCDC_LENGTH_13 (4 byte)"        ,       1952 },
   {  "MQCDC_LENGTH_13 (8 byte)"        ,       2000 },
   {  "MQCDC_LENGTH_2"                  ,       1312 },
   {  "MQCDC_LENGTH_3"                  ,       1480 },
   ...
   {  "MQCDC_VERSION_8"                 ,          8 },
   {  "MQCDC_VERSION_9"                 ,          9 },
   {  "MQCD_CURRENT_LENGTH (4 byte)"    ,       1952 },
   {  "MQCD_CURRENT_LENGTH (8 byte)"    ,       2000 },
   ...
   {  "MQCD_LENGTH_13 (4 byte)"         ,       1952 },
   {  "MQCD_LENGTH_13 (8 byte)"         ,       2000 },
   {  "MQCD_LENGTH_2"                   ,       1312 },
   {  "MQCD_LENGTH_3"                   ,       1480 },
