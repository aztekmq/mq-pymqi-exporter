...
class _CollectorSession:
    ...
    system_topic_records: dict[tuple[str, tuple[tuple[str, str], ...]], MetricRecord] | None = None
...
Q_MGR_SPECS = {
    ...
    "MQIA_MAX_HANDLES": _MetricSpec("ibmmq_qmgr_max_handles", "Maximum handles allowed per connection."),
    "MQIA_MAX_MSG_LENGTH": _MetricSpec("ibmmq_qmgr_max_message_length_bytes", "Maximum message length in bytes."),
    "MQIA_MAX_PRIORITY": _MetricSpec("ibmmq_qmgr_max_priority", "Maximum message priority."),
    "MQIA_MAX_UNCOMMITTED_MSGS": _MetricSpec("ibmmq_qmgr_max_uncommitted_messages", "Maximum uncommitted messages per unit of work."),
    "MQIA_TRIGGER_INTERVAL": _MetricSpec("ibmmq_qmgr_trigger_interval_milliseconds", "Queue manager trigger interval in milliseconds."),
    "MQIA_STATISTICS_INTERVAL": _MetricSpec("ibmmq_qmgr_statistics_interval_seconds", "Queue manager statistics collection interval."),
    "MQIA_ACCOUNTING_INTERVAL": _MetricSpec("ibmmq_qmgr_accounting_interval_seconds", "Queue manager accounting collection interval."),
    "MQIA_STATISTICS_MQI": _MetricSpec("ibmmq_qmgr_statistics_mqi_enabled", "MQI statistics setting."),
    "MQIA_STATISTICS_Q": _MetricSpec("ibmmq_qmgr_statistics_queue_enabled", "Queue statistics setting."),
    "MQIA_STATISTICS_CHANNEL": _MetricSpec("ibmmq_qmgr_statistics_channel_level", "Channel statistics level."),
    "MQIA_MONITORING_Q": _MetricSpec("ibmmq_qmgr_queue_monitoring_level", "Default queue monitoring level."),
    "MQIA_MONITORING_CHANNEL": _MetricSpec("ibmmq_qmgr_channel_monitoring_level", "Default channel monitoring level."),
}
...
QUEUE_SPECS = {
    ...
    "MQIA_MAX_MSG_LENGTH": _MetricSpec("ibmmq_queue_max_message_length_bytes", "Maximum message length in bytes."),
    "MQIA_MSG_DELIVERY_SEQUENCE": _MetricSpec("ibmmq_queue_message_delivery_sequence", "Message delivery sequence setting."),
    "MQIA_PRIORITY": _MetricSpec("ibmmq_queue_default_priority", "Default message priority."),
    "MQIA_DEF_PERSISTENCE": _MetricSpec("ibmmq_queue_default_persistence", "Default message persistence setting."),
    "MQIA_INHIBIT_GET": _MetricSpec("ibmmq_queue_get_inhibited", "Whether gets are inhibited."),
    "MQIA_INHIBIT_PUT": _MetricSpec("ibmmq_queue_put_inhibited", "Whether puts are inhibited."),
    "MQIA_TRIGGER_CONTROL": _MetricSpec("ibmmq_queue_trigger_enabled", "Whether triggering is enabled."),
    "MQIA_TRIGGER_DEPTH": _MetricSpec("ibmmq_queue_trigger_depth", "Trigger depth."),
    "MQIA_TRIGGER_MSG_PRIORITY": _MetricSpec("ibmmq_queue_trigger_message_priority", "Trigger message priority."),
    "MQIA_TRIGGER_TYPE": _MetricSpec("ibmmq_queue_trigger_type", "Trigger type."),
    "MQIA_Q_DEPTH_HIGH_LIMIT": _MetricSpec("ibmmq_queue_depth_high_limit_percent", "Queue high-depth threshold percentage."),
    "MQIA_Q_DEPTH_LOW_LIMIT": _MetricSpec("ibmmq_queue_depth_low_limit_percent", "Queue low-depth threshold percentage."),
    "MQIA_Q_DEPTH_MAX_EVENT": _MetricSpec("ibmmq_queue_depth_max_event_enabled", "Queue-full event setting."),
    "MQIA_Q_DEPTH_HIGH_EVENT": _MetricSpec("ibmmq_queue_depth_high_event_enabled", "Queue high-depth event setting."),
    "MQIA_Q_DEPTH_LOW_EVENT": _MetricSpec("ibmmq_queue_depth_low_event_enabled", "Queue low-depth event setting."),
    "MQIA_SERVICE_INTERVAL": _MetricSpec("ibmmq_queue_service_interval_milliseconds", "Queue service interval in milliseconds."),
    "MQIA_USAGE": _MetricSpec("ibmmq_queue_usage", "Queue usage type."),
    "MQIA_SHAREABILITY": _MetricSpec("ibmmq_queue_shareability", "Queue input shareability setting."),
    "MQIA_MONITORING_Q": _MetricSpec("ibmmq_queue_monitoring_level", "Queue monitoring level."),
}

QUEUE_STATUS_SPECS = {
    "MQIA_CURRENT_Q_DEPTH": _MetricSpec("ibmmq_queue_status_current_depth", "Current queue depth from queue status."),
    "MQIA_OPEN_INPUT_COUNT": _MetricSpec("ibmmq_queue_status_open_input_count", "Open input handles from queue status."),
    "MQIA_OPEN_OUTPUT_COUNT": _MetricSpec("ibmmq_queue_status_open_output_count", "Open output handles from queue status."),
    "MQIACF_UNCOMMITTED_MSGS": _MetricSpec("ibmmq_queue_uncommitted_messages", "Uncommitted messages associated with the queue."),
    "MQIACF_OLDEST_MSG_AGE": _MetricSpec("ibmmq_queue_oldest_message_age_seconds", "Age of the oldest message on the queue."),
}
...
CHANNEL_SPECS = {
    ...
    "MQIACH_MSGS": _MetricSpec("ibmmq_channel_messages", "Messages transferred on the channel."),
    "MQIACH_BUFFERS_SENT": _MetricSpec("ibmmq_channel_buffers_sent", "Transmission buffers sent on the channel."),
    "MQIACH_BUFFERS_RCVD": _MetricSpec("ibmmq_channel_buffers_received", "Transmission buffers received on the channel."),
    "MQIACH_BATCH_SIZE": _MetricSpec("ibmmq_channel_batch_size", "Configured channel batch size."),
    "MQIACH_BATCHES": _MetricSpec("ibmmq_channel_batches", "Batches transferred on the channel."),
    "MQIACH_CURRENT_MSGS": _MetricSpec("ibmmq_channel_current_messages", "Messages currently being processed by the channel."),
    "MQIACH_CURRENT_SEQ_NUMBER": _MetricSpec("ibmmq_channel_current_sequence_number", "Current channel sequence number."),
    "MQIACH_LAST_SEQ_NUMBER": _MetricSpec("ibmmq_channel_last_sequence_number", "Last channel sequence number."),
    "MQIACH_INDOUBT_STATUS": _MetricSpec("ibmmq_channel_indoubt_status", "Whether the channel is in doubt."),
    "MQIACH_NETWORK_TIME_INDICATOR": _MetricSpec("ibmmq_channel_network_time_indicator", "Channel network time indicator."),
    "MQIACH_XMITQ_TIME_INDICATOR": _MetricSpec("ibmmq_channel_transmission_queue_time_indicator", "Channel transmission queue time indicator."),
    "MQIACH_MCA_STATUS": _MetricSpec("ibmmq_channel_mca_status", "Message channel agent status."),
    "MQIACH_CHANNEL_SUBSTATE": _MetricSpec("ibmmq_channel_substate", "Detailed channel substate."),
}
...
ADMIN_QUEUE_MESSAGE_SPECS = {
    ...
    "event": _MetricSpec("ibmmq_event_messages_consumed", "Administrative event messages consumed during the last poll."),
}
...
class PyMQICollector:
    ...
    def collect(self, config: QueueManagerConfig) -> list[MetricRecord]:
        ...
        while True:
            ...
            try:
                ...
                LOG.warning(
                    "Reconnecting MQ session for %s after stale/broken connection error: %s",
                    config.name,
                    exc,
                )
    ...
    def _collect_event_metrics(self, config: QueueManagerConfig, qmgr) -> list[MetricRecord]:
        ...
        for queue_name in EVENT_QUEUES:
            try:
                records.extend(
                    self._collect_admin_queue_metrics(
                        config,
                        qmgr,
                        queue_name=queue_name,
                        source_name="event",
                        parser=self._parse_event_message,
                    )
                )
    ...
    def _collect_amqsruac_resource_metrics(
        ...
        *,
        ...
        jobs: list[tuple[str, str, str | None]] = [
            ("CPU", "SystemSummary", None),
            ("CPU", "QMgrSummary", None),
            ("DISK", "SystemSummary", None),
            ("DISK", "QMgrSummary", None),
            ("DISK", "Log", None),
            ("STATMQI", "CONNDISC", None),
            ("STATMQI", "OPENCLOSE", None),
            ("STATMQI", "INQSET", None),
            ("STATMQI", "PUT", None),
            ("STATMQI", "GET", None),
            ("STATMQI", "SYNCPOINT", None),
        ...
        def collect_one(job: tuple[str, str, str | None]) -> list[MetricRecord]:
            monitor_class, monitor_type, object_name = job
            command = [
                executable, "-m", config.connection.queue_manager or config.name,
                "-c", monitor_class, "-t", monitor_type, "-n", "1",
            ]
            if object_name:
                command.extend(("-o", object_name))
            try:
                ...
                LOG.warning("amqsruac collection failed for %s/%s on %s: %s", monitor_class, monitor_type, config.name, exc)
                return []

            records: list[MetricRecord] = []
            labels = {"qmgr": config.name, "monitor_type": monitor_type}
            if object_name:
                labels["application"] = object_name
            for line in (result.stdout + "\n" + result.stderr).splitlines():
                ...
                if not match or line.startswith("Publication received"):
                    continue
                descriptor, raw_value, unit, rate_value = match.groups()
                if object_name and descriptor.startswith(object_name):
                    descriptor = descriptor[len(object_name):].strip()
                metric_key = self._normalize_monitor_descriptor(descriptor).replace(" ", "_")
                ...
                if unit == "%":
                    ...
                    suffix = "_microseconds"
                elif "byte" in descriptor.lower():
                    suffix = "_bytes"
                records.append(
                    MetricRecord(
                        name=f"ibmmq_{monitor_class.lower()}_{metric_key}{suffix}",
                        documentation=f"IBM MQ {monitor_class} resource metric reported by amqsruac: {descriptor}.",
                        labels=labels,
                        value=value,
                    )
                )
                if rate_value is not None:
                    rate_suffix = "_bytes_per_second" if "byte" in descriptor.lower() else "_per_second"
                    records.append(
                        MetricRecord(
                            name=f"ibmmq_{monitor_class.lower()}_{metric_key}{rate_suffix}",
                            documentation=f"IBM MQ {monitor_class} resource rate reported by amqsruac: {descriptor}.",
                            labels=labels,
    ...
    def _get_or_create_session(self, config: QueueManagerConfig) -> _CollectorSession:
        ...
        try:
            if getattr(config.metrics, "include_system_topic_stream", False):
                stream_qmgr = self._connect(config, isolated=True)
    ...
    def _connect(self, config: QueueManagerConfig, *, isolated: bool = False):
        ...
        try:
            if config.connection.channel and config.connection.conn_name:
                cd = self.pymqi.CD()
                cd.ChannelName = config.connection.channel.encode()
                cd.ConnectionName = config.connection.conn_name.encode()
                cd.ChannelType = self.pymqi.CMQC.MQCHT_CLNTCONN
                cd.TransportType = self.pymqi.CMQC.MQXPT_TCP
                # Polls may execute on different worker-pool threads. Without
                # an explicitly shareable HCONN, IBM MQ returns
                # MQRC_HCONN_ERROR when a later poll runs on another thread.
                connect_options = getattr(self.pymqi.CMQC, "MQCNO_HANDLE_SHARE_BLOCK", 0)
    ...
    def _discover_monitor_types(self, config: QueueManagerConfig, qmgr) -> list[_DiscoveredMonitorType]:
        ...
        metadata_root = f"$SYS/MQ/INFO/QMGR/{qmgr_name}/Monitor/METADATA/CLASSES/en_US"
    ...
    def _collect_queue_metrics(self, config: QueueManagerConfig, pcf) -> list[MetricRecord]:
        ...
        for pattern in config.metrics.queue_patterns:
            ...
            status_method = getattr(pcf, "MQCMD_INQUIRE_Q_STATUS", None)
            if status_method is None:
                continue
            status_responses = self._call_pcf(
                status_method,
                config,
                operation="MQCMD_INQUIRE_Q_STATUS",
                object_type="queue",
                object_name=pattern,
                arguments={queue_name_attr: pattern},
            )
            for response in status_responses:
                ...
                for attr_name, spec in QUEUE_STATUS_SPECS.items():
                    ...
                    if value is not None:
                        records.append(MetricRecord(spec.metric_name, spec.help_text, {"qmgr": config.name, "queue": queue_name}, value))
        return records
    ...
    def _collect_system_topic_stream_metrics(self, config: QueueManagerConfig, session: _CollectorSession) -> list[MetricRecord]:
        ...
        for subscription in session.subscriptions:
            ...
            for md, payload in self._drain_queue(queue, config, topic_object, max_messages=max_messages - drained):
                drained += 1
                parsed = self._parse_system_topic_publication(config, md, payload, fallback_topic=fallback_topic)
                records.extend(parsed)
                if session.system_topic_records is None:
                    session.system_topic_records = {}
                for record in parsed:
                    key = (record.name, tuple(sorted(record.labels.items())))
                    session.system_topic_records[key] = record
        ...
        if session.system_topic_records:
            current_keys = {(record.name, tuple(sorted(record.labels.items()))) for record in records}
            records.extend(record for key, record in session.system_topic_records.items() if key not in current_keys)
        return records
    ...
    def _parse_event_message(self, config: QueueManagerConfig, queue_name: str, md, payload: bytes) -> list[MetricRecord]:
        records = [
            MetricRecord(
                name="ibmmq_event_occurrences",
                documentation="Administrative IBM MQ events consumed during the last poll.",
                labels={"qmgr": config.name, "queue": queue_name},
                value=1.0,
            )
        ]
        try:
            unpacked = self._unpack_pcf_message(config, queue_name, payload, operation="parse administrative event message")
        except MQCollectionError:
            return records

        def visit(data: Any, context: str = "root") -> None:
            if isinstance(data, dict):
                for key, value in data.items():
                    selector = self._selector_name(key)
                    numeric = self._coerce_numeric(value)
                    if selector and numeric is not None:
                        records.append(
                            MetricRecord(
                                name="ibmmq_event_attribute",
                                documentation="Numeric PCF attribute carried by an IBM MQ administrative event.",
                                labels={
                                    "qmgr": config.name,
                                    "queue": queue_name,
                                    "attribute": selector,
                    ...
                    if isinstance(value, (dict, list)):
                        visit(value, selector or context)
    ...
    def _message_labels(self, config: QueueManagerConfig, queue_name: str, md, group: dict[Any, Any]) -> dict[str, str]:
        ...
        if appl_name and appl_name not in {"<unknown>", config.name}:
            observed = getattr(self, "_observed_applications", None)
            if observed is not None:
                observed.setdefault(config.name, set()).add(appl_name)
        return {
            "qmgr": config.name,
            "queue": queue_name,
