...
class MetricsConfig:
    ...
    system_topic_subscription_patterns: tuple[str, ...] = ("$SYS/MQ/INFO/QMGR/{qmgr}/#",)
...
def load_exporter_config(path: str | Path) -> ExporterConfig:
    ...
    for file_path in sorted(qmgr_path.glob("*.yaml")):
        ...
        metrics = MetricsConfig(
            ...
            system_topic_subscription_patterns=tuple(metrics_raw.get("system_topic_subscription_patterns", ["$SYS/MQ/INFO/QMGR/{qmgr}/#"])),
