 /* @(#) MQMBID sn=p924-L211105.DE su=_EPg06D4VEeygWfM06SbNXw pn=samples/c/amqsruaa.c.pre */
 /********************************************************************/
 /*                                                                  */
                 ...
                 , MQLONG   topic_ccsid )
{
   ...
   if( pClass )
   {
       ...
       if( NULL == pType )
       {
         printf("topic: %d.%d (%.*s)  unexpectedly not found"
               , class_id, type_id, topic_len, topic );
         return ERROR_RETURN;
       }
       ...
       {
         printf("topic metadata: %d.%d (%.*s)  unexpectedly short"
               , class_id, type_id, topic_len, topic );
         return -1;
       }
